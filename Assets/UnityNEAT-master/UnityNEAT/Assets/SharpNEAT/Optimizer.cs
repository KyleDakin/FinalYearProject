//From UnityNEAT Package written by Daniel Jallov
...
public class Optimizer : MonoBehaviour {
	...
	void Start () {
        ...
        experiment.Initialize("Ecosystem Experiment", xmlConfig.DocumentElement, NUM_INPUTS, NUM_OUTPUTS);

        champFileSavePath = Application.persistentDataPath + string.Format("/{0}_{1}.champ.xml", Unit.name, sceneName);
        popFileSavePath = Application.persistentDataPath + string.Format("/{0}_{1}.pop.xml", Unit.name, sceneName);       
    ...
    {        
        Utility.DebugLog = true;
        Utility.Log("Starting Ecosystem experiment");
    ...
    {
        GameObject obj = Instantiate(Unit, GameManager.Instance.GetRandomGrassTile(), Unit.transform.rotation) as GameObject;
